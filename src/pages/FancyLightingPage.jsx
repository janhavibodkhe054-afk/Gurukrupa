  ...
  >
    ...
    <div className="mt-[40px] space-y-[26px]">
      ...
      <p className="text-[#5F6B7A] text-[16px] sm:text-[18px] leading-[38px] font-light">
        ...
        and commercial interiors with stylish illumination and premium appeal.
      </p>
      ...
      <p className="text-[#5F6B7A] text-[16px] sm:text-[18px] leading-[38px] font-light">
        ...
        multiple styles, patterns, and finishes to match contemporary
        as well as classic interior themes. Every product is carefully
      ...
      <p className="text-[#5F6B7A] text-[16px] sm:text-[18px] leading-[38px] font-light">
        ...
        beauty while maintaining durability and long-lasting performance.
      </p>

      <p className="text-[#5F6B7A] text-[16px] sm:text-[18px] leading-[38px] font-light">
        With a strong focus on quality craftsmanship, modern trends,
        and innovative lighting concepts, our elegant decorative
        lighting range is trusted by architects, interior designers,
        builders, and homeowners seeking premium lighting solutions
        that combine functionality with luxurious style.
      </p>
