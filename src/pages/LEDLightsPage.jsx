...
export default function LEDLightsPage() {
  const galleryItems = [
    {
      image: "https://m.media-amazon.com/images/I/81AW4nLgOTL.jpg",
      title: "LED Panel",
      subtitle: "Lights",
    },
    {
          ...
          <div className="max-w-[1600px] mx-auto w-full px-[20px] sm:px-[35px] lg:px-[60px]">
            ...
            >
              ...
              <p className="mt-[28px] text-white/90 text-[15px] sm:text-[17px] leading-[34px] max-w-[560px]">
                Modern lighting solutions designed to deliver elegance,
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          >
            ...
            <div className="mt-12 space-y-2 w-full">
              <p className="text-blacak text-[17px] sm:text-[19px] leading-[2.1] font-light text-justify w-full">
                Our premium LED lighting solutions are designed to deliver the
                perfect combination of modern aesthetics, superior brightness,
                energy efficiency, and long-lasting performance. Manufactured
                using advanced lighting technology and premium-quality
                components, these products provide reliable illumination while
                significantly reducing power consumption and maintenance costs.
              </p>
              ...
              <p className="text-black text-[17px] sm:text-[19px] leading-[2.1] font-light text-justify w-full">
                ...
                offices to showrooms, hotels, retail spaces, and large
                commercial projects, our lighting solutions enhance interiors
                while maintaining consistent illumination quality and
              ...
              <p className="text-black text-[17px] sm:text-[19px] leading-[2.1] font-light text-justify w-full">
                By combining innovative technology, elegant styling, and
                dependable performance, our lighting products help create
                efficient and sustainable spaces with enhanced visibility,
                comfort, and modern architectural appeal for every environment.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-[1600px] mx-auto px-[20px] sm:px-[35px] lg:px-[50px]">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-[30px] mb-[55px]">
            ...
            <p className="text-[#666] text-[16px] leading-[32px] max-w-[420px]">
              Explore elegant LED lighting collections designed for modern
              interiors and premium spaces.
            </p>
          </div>
