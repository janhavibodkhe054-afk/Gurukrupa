  ...
  const cableTypes = [
    {
      ...
      number: "01",
      desc: "Safe and reliable wiring solutions for residential and commercial buildings.",
    },
    {
      title: "Flexible Wires",
      number: "02",
      desc: "Highly flexible conductors for appliances, panels, and machinery.",
    },
    {
      title: "Power Cables",
      number: "03",
      desc: "Efficient power transmission for industrial and infrastructure projects.",
    },
    {
      title: "Armoured Cables",
      number: "04",
      desc: "Extra protection for underground and harsh environments.",
    },
    {
      title: "Control Cables",
      number: "05",
      desc: "Reliable signal and control transmission for automation systems.",
    },
    {
      title: "XLPE Cables",
      number: "06",
      desc: "High-performance cables with superior thermal resistance.",
    },
  ];
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-5">
          <div>
            ...
            <h1 className="text-white text-4xl md:text-6xl font-bold tracking-tight font-black">
              Electrical Wires
              <span className="text-[#F28C28]"> & Cables</span>
            </h1>
          </div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-20 items-center">
          ...
          >
            ...
            <p className="mt-8 text-gray-500 text-base md:text-lg max-w-[720px] leading-relaxed">
              Our electrical wires and cables are manufactured using
              premium-grade conductors and advanced insulation technology,
              ensuring safe, efficient, and uninterrupted power transmission for
              residential, commercial, and industrial applications.
            </p>

            <p className="mt-4 text-gray-500 text-base md:text-lg max-w-[720px] leading-relaxed">
              Engineered for durability, flexibility, and long-term performance,
              every product undergoes rigorous quality testing to deliver
              superior reliability, enhanced safety, and consistent electrical
              performance.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-5">
          ...
          <div className="text-left md:text-center mb-10">
            ...
            <h2 className="mt-4 text-[#16265E] text-[28px] md:text-[44px] leading-[1.1] font-bold">
              Wire & Cable
              <span className="text-[#F28C28]"> Solutions</span>
            </h2>

            <p className="mt-4 text-gray-500 max-w-3xl mx-auto text-base md:text-lg leading-8">
              Premium electrical wiring solutions engineered for safety,
