  ...
  return (
    <section className="relative w-full bg-[#0E0E0E] py-14 lg:py-16 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        ...
        <h1 className="text-[70px] md:text-[140px] lg:text-[200px] font-black text-white/[0.03] uppercase tracking-[10px] select-none">
          Gurukrupa
        </h1>
      </div>
      ...
      <div className="relative max-w-[1450px] mx-auto px-5 lg:px-10">
        ...
        <div className="grid lg:grid-cols-3 gap-10 items-start">
          ...
          >
            ...
            <p className="text-gray-400 text-[15px] leading-[28px] mt-6 max-w-md">
          ...
          <div className="lg:col-span-2 grid md:grid-cols-2 gap-4 w-full">
            ...
            {features.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
                className="group relative border border-white/10 hover:border-[#4F8CC9] bg-white/[0.02] px-5 py-5 transition-all duration-500 w-full"
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <motion.div
                    ...
                    className="w-12 h-12 min-w-[48px] border border-white/10 group-hover:border-[#4F8CC9] rounded-lg flex items-center justify-center text-[#4F8CC9] transition duration-500"
                  >
                  ...
                  <div className="flex-1">
                    ...
                    {/* DESC */}
                    <p className="text-gray-400 leading-[26px] text-[14px]">
                      {item.desc}
                    </p>
                  </div>
                </div>
